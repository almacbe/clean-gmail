...
export function PromotionsTable({ emails }: PromotionsTableProps) {
  if (emails.length === 0) {
    return (
      <div
        ...
        <tfoot>
          <tr>
            <td
              ...
              data-testid="promotions-count"
            >
              {emails.length} promotional email{emails.length !== 1 ? 's' : ''}
            </td>
            <td
              className="text-right font-semibold"
              data-testid="promotions-total-size"
            >
