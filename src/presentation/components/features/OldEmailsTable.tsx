...
export function OldEmailsTable({
  emails,
  selectedIds = new Set(),
  onToggle,
  onSelectAll,
          ...
          <tr>
            <th className="w-8">
              <input
                ...
                aria-label="Select all old emails"
              />
            </th>
            <th>Sender</th>
            <th>Subject</th>
        ...
        <tfoot>
          <tr>
            ...
            <td
              ...
              data-testid="old-emails-count"
            >
              {emails.length} old email{emails.length !== 1 ? 's' : ''}
            </td>
            <td
              className="text-right font-semibold"
              data-testid="old-emails-total-size"
            >
