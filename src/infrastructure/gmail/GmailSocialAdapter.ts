...
const MAX_PAGES = 5; // cap at 500 social emails

const defaultDelay = (ms: number): Promise<void> =>
  new Promise<void>((resolve) => setTimeout(resolve, ms));

export class GmailSocialAdapter implements SocialScanner {
  ...
  async scanSocial(accessToken: string): Promise<EmailMetadata[]> {
