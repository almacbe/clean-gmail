...
const MAX_PAGES = 5; // cap at 500 promotional emails

const defaultDelay = (ms: number): Promise<void> =>
  new Promise<void>((resolve) => setTimeout(resolve, ms));

export class GmailPromotionsAdapter implements PromotionsScanner {
  ...
  async scanPromotions(accessToken: string): Promise<EmailMetadata[]> {
